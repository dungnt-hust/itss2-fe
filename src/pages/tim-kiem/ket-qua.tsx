    ...
    <div>
      ...
      <div className="p-6">
        <div className="flex items-center justify-between mb-10">
          <div className="text-xl">1-18 / 234 </div>
          <div className="text-xl flex items-center gap-5">
            Sắp xếp theo: <Select style={{ width: 160 }} options={[{ value: "jack", label: "Thành viên mới " }]} />
          </div>
        </div>
        <div className="grid grid-cols-6 gap-6 max-w-[100rem] mx-auto">
          {[...Array(10)].map((value: any, index) => (
            <div key={index} className="border border-solid border-black">
              <img src="/images/girl.png" className="w-full aspect-square object-cover mb-2" alt="" />
